...
<b>Selected Scope</b><br/>
<textarea id="selected_scope" name="selected_scope" class="text ui-widget-content ui-corner-all" style="width: 70%;" rows="7" readonly></textarea>
